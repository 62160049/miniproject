...
<center><br><font size="12px"><b style=color:rgb(25,25,112)> แนวเกมยอดฮิต<br></center></font><br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div>
                                ...
                                <p><a class="btn btn-primary" href="blog.php?article_id=<?php echo $row["id"]; ?>" role="button">Read More &raquo;</a></p>
                            </div>
                        </div>
                    </div>
                    <br>
